   ...
   <section>
	   ...
	   <div class="wrap write_form">
	      ...
	      <table class="table table-striped">
	         <form name="programWriteForm" action="${contextPath }/programBoard/writeSaveForProgram" enctype="multipart/form-data" method="post">
	            <tr>
	               <th><b> 작성자 </b><br></th>
	            ...
	            <tr>
	               ...
	               <td>
	                  ...
	                  <datalist id="petKind_list">
	                     ...
	                     <option value="댄디 딘몬트 테리어" label="댄디 딘몬트 테리어 (Dandie Dinmont Terrier)"/> 
	                     ...
	                     <option value="래브라도 리트리버" label="래브라도 리트리버 (Labrador Retriever)"/> 
	                     <option value="러시안 베어 슈나우져" label="러시안 베어 슈나우져"/> 
	                     <option value="로디지아 리지백" label="로디지아 리지백 (Rhodesian Ridgeback)"/> 
	                     ...
	                     <option value="버니즈 마운틴 독" label="버니즈 마운틴 독 (Bernese Mountain Dog)"/>
	                     ...
	                     <option value="보비에 드 플란더스" label="보비에 드 플란더스 (Bouvier Des Flandres)"/> 
	                     ...
	                     <option value="블랙 앤 탄 쿤하운드" label="블랙 앤 탄 쿤하운드 (Black & Tan Coonhound)"/>
	                     ...
	                     <option value="스코티쉬 디어하운드" label="스코티쉬 디어하운드 (Scottish Deerhound)"/> 
	                     <option value="스코티쉬 테리어" label="스코티쉬 테리어 (Scottish Terrier)"/> 
	                     <option value="스키퍼키" label="스키퍼키 (Schipperke)"/> 
	                     <option value="스태퍼드쉬어 불 테리어" label="스태퍼드쉬어 불 테리어 (Staffordshire Bull Terrier)"/> 
	                     ...
	                     <option value="아메리칸 폭스 하운드" label="아메리칸 폭스 하운드 (American Foxhound)"/> 
	                     ...
	                     <option value="오스트랄리안 테리어" label="오스트랄리안 테리어 (Australian Terrier)"/> 
	                     <option value="오스트레일리안 캐틀 독" label="오스트레일리안 캐틀 독 (Australian Cattle Dog)"/> 
	                     ...
	                     <option value="잉글리쉬 코커 스파니엘" label="잉글리쉬 코커 스파니엘 (English Cocker Spaniel)"/> 
	                     ...
	                     <option value="잭 러셀 테리어" label="잭 러셀 테리어(Jack Russell Terrier)"/> 
	                     ...
	                     <option value="차이니즈 크레스티드 독" label="차이니즈 크레스티드 독 (Chinese Crested Dog)"/> 
	                     ...
	                     <option value="케리 블루 테리어" label="케리 블루 테리어 (Kerry Blue Terrier)"/> 
	                     ...
	                     <option value="킹 찰스 스파니엘" label="킹 찰스 스파니엘 (King Charles Spaniel)"/> 
