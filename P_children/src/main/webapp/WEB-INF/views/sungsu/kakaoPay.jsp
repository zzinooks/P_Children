...
<body>
	...
	<section>
		<form action="${path }/member/kakaoPay">
			...
			<input type="text" id="itemName" name="item_name" value="${title }" readonly/>
			<br><br>
			<label>상품 수량</label><br>
			<input type="text" id="quantity" name="quantity" value="${quantity }" readonly/>
			<br><br>
			<label>상품 총액</label><br>
			<input type="text" id="totalAmount" name="total_amount" value="${total_amount }" readonly/>
			<br><br>
			<label>상품 비과세 금액</label><br>
			<input type="text" id="taxFreeAmount" name="tax_free_amount" value="${tax_free_amount }" readonly/>
			<br><br>
